...
- `AutoMoT/tools/eval_sft_v1.py`
  （以上 4 个是 LoRA SFT v1 微调相关；`AutoMoT/tools/` 下其它原始脚本仍为只读参考）
...
git add AutoMoT/tools/SFT_V1_PLAN.md AutoMoT/tools/build_sft_dataset_v1.py AutoMoT/tools/sft_v1_train.sh AutoMoT/tools/eval_sft_v1.py
```
