...
用法（从 AutoMoT/ 目录）：
  python qwen3vl_local/sft_baseline/audit_rs_event_cooccurrence.py \
    --collection-dir keyframe_filter/collection_output \
    --output-json checkpoints/sft_baseline_data/rs_event_cooccurrence.json
...
from qwen3vl_local.sft_baseline.build_dataset import _skip_sets  # noqa: E402
