"""构建 SFT baseline 的 route-level sequence index。
...
def parse_args() -> argparse.Namespace:
    ...
    p = argparse.ArgumentParser(description="Build SFT baseline highway/RE-UE sequence dataset")
    ...
    p.add_argument("--output-dir", type=str, default="checkpoints/sft_baseline_data")
...
def main() -> None:
    ...
    print(f"[sft_baseline build] outputs: {summary['train_path']} | {summary['val_path']}")
