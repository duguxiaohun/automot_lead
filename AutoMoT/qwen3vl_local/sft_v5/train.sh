...
echo "[probe] CHECKPOINT_PROBE=${CHECKPOINT_PROBE:-1} BASE=${CHECKPOINT_PROBE_BASE:-1} TEACHER=${CHECKPOINT_PROBE_WITH_TEACHER:-1} CASES=${CHECKPOINT_PROBE_NUM_CASES:-8} MODE=${CHECKPOINT_PROBE_SAMPLE_MODE:-diagnostic} RADIUS=${CHECKPOINT_PROBE_CONTEXT_RADIUS:-2}"
...
COMMON_ARGS=(
  ...
  --checkpoint-probe-sample-mode "${CHECKPOINT_PROBE_SAMPLE_MODE:-diagnostic}"
  --checkpoint-probe-context-radius "${CHECKPOINT_PROBE_CONTEXT_RADIUS:-2}"
