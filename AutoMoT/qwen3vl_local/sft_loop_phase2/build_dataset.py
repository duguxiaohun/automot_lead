...
from qwen3vl_local.sft_loop_phase2.prompts import ANSWER_KEYS  # noqa: E402
from qwen3vl_local.sft_loop_phase2.visual_audit import (  # noqa: E402
...
def build_dataset(args: argparse.Namespace) -> Dict[str, Any]:
    ...
    manifest = {
        "format": "sft_loop_phase2_frame_index",
        "dataset_name": DATASET_NAME,
        ...
        "focus_bin_coverage_contract": "Every split contains all four questions with YES/NO available; train/eval sample eight focus bins to exact equality.",
    }
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--output-dir", default=str(_AUTOMOT_ROOT / "checkpoints/sft_loop_phase2_data"))
    p.add_argument(
        "--review-root",
...
if __name__ == "__main__":
    ...
    print(f"sft_loop_phase2 dataset: frames={sum(value for key, value in manifest['counts'].items() if key.count('/') == 1)} output={manifest['frame_index']}")
