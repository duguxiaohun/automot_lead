...
run_eval "6/10 LoRA 4rgb production" --adapter-dir checkpoints/sft_loop_phase2_runs/run_rs_four_binary_format_supervised_4rgb/final
run_eval "7/10 LoRA 4rgb audit" --adapter-dir checkpoints/sft_loop_phase2_runs/run_rs_four_binary_format_supervised_4rgb/final --audit-prompt

run_train "8/10 train 2rgb_endpoints LoRA" 2rgb_endpoints
run_eval "9/10 LoRA 2rgb_endpoints production" --adapter-dir checkpoints/sft_loop_phase2_runs/run_rs_four_binary_format_supervised_2rgb_endpoints/final
run_eval "10/10 LoRA 2rgb_endpoints audit" --adapter-dir checkpoints/sft_loop_phase2_runs/run_rs_four_binary_format_supervised_2rgb_endpoints/final --audit-prompt
