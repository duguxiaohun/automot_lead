...
#   GPU_IDS=0,1,2,3 bash qwen3vl_local/action_expert_ablation/bev_only/smoke.sh
...
bash qwen3vl_local/action_expert_ablation/bev_only/train.sh --max-train-steps "$MAX_TRAIN_STEPS" "$@"
