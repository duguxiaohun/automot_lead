"""SFT v4 episode index 构建脚本。

与 v1/v2 不同，v4 **不生成 per-frame 训练样本 jsonl**。
...
def split_train_val(
    ...
    v4 的训练样本是一整段时间序列，如果同一个 run 的相邻帧分别进入 train/val，
...
def parse_args() -> argparse.Namespace:
    ...
    p = argparse.ArgumentParser(description="SFT v4 episode index builder")
    ...
    p.add_argument("--output-dir", type=str, default="checkpoints/sft_v4_data",
