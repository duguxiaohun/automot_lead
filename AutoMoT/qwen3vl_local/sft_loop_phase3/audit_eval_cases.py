#!/usr/bin/env python3
"""从 Phase3 eval 产物中抽取少量错例并补齐真实 RGB。
...
DEFAULT_EVAL_DIR = _AUTOMOT_ROOT / "checkpoints/sft_loop_phase3_eval/base_event_gate_final_4rgb"
DEFAULT_OUTPUT_DIR = _AUTOMOT_ROOT / "checkpoints/sft_loop_phase3_audit_samples/base_event_gate_4rgb"
...
def _render_summary(summary: Mapping[str, Any]) -> str:
    ...
    lines = [
        "# Phase3 Event-Gate Eval Audit Samples",
        "",
