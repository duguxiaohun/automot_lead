"""静态检查 SFT base simple 的单问直接答案监督 span。
...
from qwen3vl_local.sft_base_simple.labels import EventTarget, RSTarget
from qwen3vl_local.sft_base_simple.prompts import (
    Memory,
    build_q1_target,
    parse_q1_output,
    target_spans_q1,
...
def main() -> None:
    ...
    print("[sft_base_simple check_loss_mask] ok")
