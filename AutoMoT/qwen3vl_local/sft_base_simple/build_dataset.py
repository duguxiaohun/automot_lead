...
def _build_frame_row(
    *,
    ...
    """把一帧完整 annotation 压缩成 baseline 训练需要的字段。"""
...
def parse_args() -> argparse.Namespace:
    ...
    p = argparse.ArgumentParser(description="Build SFT base simple highway/RE-UE sequence dataset")
    ...
    p.add_argument("--output-dir", type=str, default="checkpoints/sft_base_simple_data")
