...
用法（从 AutoMoT/ 目录）：
  python qwen3vl_local/sft_base_simple/audit_eval_candidate_drift.py \
    --index checkpoints/sft_base_simple_data/val_sequence_index.jsonl
...
from qwen3vl_local.sft_base_simple.eval_candidates import q2_candidates_for_student_rs
from qwen3vl_local.sft_base_simple.labels import event_in_candidates, is_unusual
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(description="Audit sft_base_simple eval candidate drift")
    parser.add_argument("--index", type=str, default="checkpoints/sft_base_simple_data/val_sequence_index.jsonl")
