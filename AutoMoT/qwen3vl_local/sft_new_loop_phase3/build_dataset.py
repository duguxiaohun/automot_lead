...
def development_route_groups() -> frozenset:
    ...
    groups.update(json.loads(path.with_name("development_route_groups_20260926.json").read_text())["groups"])
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--output-dir", default=str(_AUTOMOT_ROOT / "checkpoints/sft_new_loop_phase3_data_v24"))
    p.add_argument(
        "--review-root",
        default=str(
            _AUTOMOT_ROOT
