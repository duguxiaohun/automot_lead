...
echo "[hint] eval base: GPU_IDS=0 python qwen3vl_local/sft_loop_phase1/eval.py --output-dir checkpoints/sft_loop_phase1_eval/base_prompt_v3"
echo "[hint] eval lora: GPU_IDS=0 python qwen3vl_local/sft_loop_phase1/eval.py --adapter-dir ${OUTPUT_DIR}/final --output-dir ${OUTPUT_DIR}/eval_prompt_v3"
