...
| InvadingTurn | R1, R2, R5 | 默认直道 + 无信号/STOP 路口；2026-07-04 全量逐帧 RGB 审计未见稳定信号灯路口，删除 R4 |
...
| R2 双向单车道 / 借对向车道道路 | R-E1, R-E2, U-E2, U-E5 | U-E2 表达借对向绕障核心；R-E2 只用于绕障后回原/目标车道；不放 U-E3/U-E6/U-E7/U-E8 |
...
| R5 无信号灯 / 信号灯失效路口 | R-E5, U-E4, U-E6, U-E7, U-E8, U-E5 | 不放 R-E4；U-E6 只给 CrossJunctionDefectTrafficLight 这类四向车辆冲突补充，不作为普通无灯路口默认候选；U-E5 仅允许 InvadingTurn；不放 U-E2 |
...
|---|---|---|
| Accident | R-E1, R-E2, U-E2 | U-E2 覆盖静态事故障碍占道核心；为绕障离开原车道也归 U-E2；绕过后轨迹回原/目标车道才切 R-E2，完成后回常规事件；不因普通红绿灯段加入 R-E2/R-E4 双触发 |
| AccidentTwoWays | R-E1, R-E2, U-E2 | 先 U-E2 借对向绕障，再按轨迹回归切 R-E2；R-E2 完成后回 R-E1/R-E4/R-E5；正常对向来车等待不等于 U-E5 |
| BlockedIntersection | R-E1, R-E4, U-E1, U-E8 | 红灯/正常队列只 R-E4；前车突然刹停短 span 可 U-E1；路口空间阻塞/解除核心可 R-E4+U-E8 |
| ConstructionObstacle | R-E1, R-E2, U-E2 | 同 Accident，施工静态障碍核心与避障离道为 U-E2，恢复目标车道 R-E2 |
| ConstructionObstacleTwoWays | R-E1, R-E2, U-E2 | 同 AccidentTwoWays，先 U-E2 再 R-E2，之后回常规事件 |
...
| DynamicObjectCrossing | R-E1, R-E4 | 用户先验为正常跟车/可能路口；未明确非常规前不开放 U-E3/U-E4 |
...
| HazardAtSideLane | R-E1, R-E2, U-E2 | 行人/障碍视作静态占道；若起点附近未发生变道/避让则不硬触发 U-E2；避障离道为 U-E2，回归目标车道才 R-E2 |
| HazardAtSideLaneTwoWays | R-E1, R-E2, U-E2 | 双向单车道侧向危险绕行，参考 AccidentTwoWays |
...
| InvadingTurn | R-E1, R-E5, U-E5 | 对向车辆在无信号/STOP 路口或双向窄路异常侵占自车道；不加入 U-E2 |
...
| ParkedObstacle | R-E1, R-E2, U-E2 | 静态停放障碍绕行；避障离道与绕过核心为 U-E2，同向绕过后回目标车道切 R-E2 |
| ParkedObstacleTwoWays | R-E1, R-E2, U-E2 | 双向单车道借对向绕停放障碍；先 U-E2 后 R-E2，之后回常规事件 |
| ParkingCrossingPedestrian | R-E1, R-E4, U-E4 | 进入路口前/停车遮挡区域行人横穿；U-E4 只覆盖横穿交互短 span，通过后回 R-E1，不随之后路口持续 |
...
| VehicleOpensDoorTwoWays | R-E1, R-E2, U-E2 | 开门/停车静态占道风险 + 双向单车道绕行；参考 AccidentTwoWays |
...
- `U-E5 对向车辆异常侵占自车道` 只给 InvadingTurn；primary RS 可是 R2，也可是在无信号/STOP 路口窗口内的 R5。
...
- `TwoWays` 只让候选池包含 R2/U-E2，不代表全程 R2；R2 只覆盖必须借/等对向的核心障碍 span。
  meta 缺失时允许 XML trigger 极近或 trigger-close + XML 场景障碍近距离召回短核心 R2；
