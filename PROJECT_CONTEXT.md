...
| SFT v5 RS/EVENT OPSD 跑法与可视化 | `qwen3vl_local/sft_v5/SFT_V5_RUN.md`；checkpoints 记录见 `checkpoints/SFT_V5_VISUALIZATION_RECORD.md` |
