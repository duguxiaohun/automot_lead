...
| `AutoMoT/tools/SFT_V1_PLAN.md` / `build_sft_dataset_v1.py` / `sft_v1_train.sh` / `eval_sft_v1.py` / `check_loss_mask.py` | LoRA SFT v1 微调相关脚本与计划文档（注意只这 5 个，AutoMoT/tools/ 下其它原始脚本仍为只读参考） |
